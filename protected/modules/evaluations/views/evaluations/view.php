...
$this->menu2=array(
	...
	array('label'=>'Delete Evaluation', 'url'=>'#', 'visible' => Yii::app()->user->checkAccess('Supervisor', Yii::app()->user->id), 'linkOptions'=>array('submit'=>array('delete','id'=>$model->evaluationid),'confirm'=>'Are you sure you want to delete this item?')),
);
?>
