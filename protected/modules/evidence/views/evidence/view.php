...
$this->menu2=array(
	...
	array('label'=>'<i class="icon icon-trash"></i> Delete Evidence', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->evidenceid),'confirm'=>'Are you sure you want to delete this piece of evidence?')),
);
?>
