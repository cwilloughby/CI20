...
<div id="templatemo_header">
	...
	<div id="templatemo_menu">
		<ul>
			...
			<li><a href="#"><span class="portfolio"></span>Helpdesk</a></li>
			<li><a href="#"><span class="projects"></span>Evidence</a></li>
			<li><a href="#"><span class="gallery"></span>Admin Tools</a></li>
			<li><a href="/"><span class="home"></span>IT Tools</a></li>
			<li><a href="#"><span class="portfolio"></span>Time Log</a></li>
			<li><a href="#"><span class="projects"></span>Evaluations</a></li>
			<li><a href="#"><span class="gallery"></span>Links</a></li>
			<li><a href="#"><span class="gallery"></span><?php echo Yii::app()->user->name; ?></a></li>
		</ul>
	</div>
</div>
        ...
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
					'items'=>array(
						array('label'=>'Home', 'url'=>'/', 'itemOptions'=>array('id'=>'site_title')),
						array(
