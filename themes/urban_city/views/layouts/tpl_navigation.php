		...
		<?php $this->widget('zii.widgets.CMenu',array(
				...
				'items'=>array(
					...
					array(
						...
						'items'=>array(
							array('label'=>'Create Ticket', 'url'=>array($this->createAbsoluteUrl('/tickets/troubletickets/create'))),
							array('label'=>'View Open Tickets', 'url'=>array($this->createAbsoluteUrl('/tickets/troubletickets/index'), 'status'=>'Open')),
							array('label'=>'View Closed Tickets', 'url'=>array($this->createAbsoluteUrl('/tickets/troubletickets/index'), 'status'=>'Closed')),
						),
					),
					array(
						...
						'visible'=>!Yii::app()->user->isGuest,
						'items'=>array(
							array('label'=>'Human Resources', 'url'=>array($this->createAbsoluteUrl('/hr/hrpolicy/index'))),
						),
					),
					array(
						...
						'visible'=>!Yii::app()->user->isGuest,
						'items'=>array(
							array('label'=>'Training Resources', 'url'=>array($this->createAbsoluteUrl('/training/training/typeindex'))),
						),
					),
					array(
						...
						'visible'=>!Yii::app()->user->isGuest,
						'items'=>array(
							array('label'=>'Search Documents', 'url'=>array($this->createAbsoluteUrl('/cjisucflist/doctable/searchableFileTable'))),
					...
					*/
					array(
						...
						'items'=>array(
							array('label'=>'News Management', 'url'=>array($this->createAbsoluteUrl('/news/news/index')), 'visible'=>Yii::app()->user->checkAccess('Admin', Yii::app()->user->id)),
					...
					array(
						...
						'items'=>array(
							array('label'=>'Manage Users', 'url'=>array($this->createAbsoluteUrl('/security/userinfo/index')), 'visible'=>Yii::app()->user->checkAccess('IT', Yii::app()->user->id)),
							...
							array('label'=>'Modify User Privileges', 'url'=>array($this->createAbsoluteUrl('/srbac')), 'visible'=>Yii::app()->user->checkAccess('IT', Yii::app()->user->id)),
							array('label'=>'Centriod', 'url'=>array($this->createAbsoluteUrl('/centriod/centriod/examinefiles')), 'visible'=>Yii::app()->user->checkAccess('IT', Yii::app()->user->id)),
						),
					),
					array(
						...
						'items'=>array(
							array('label'=>'Time Log', 'url'=>array($this->createAbsoluteUrl('/timelog/timelog/admin')), 'visible'=>Yii::app()->user->checkAccess('Admin', Yii::app()->user->id)),
							array('label'=>'GS Time Log', 'url'=>array($this->createAbsoluteUrl('/timelog/gstimelog/admin')), 'visible'=>(Yii::app()->user->checkAccess('IT', Yii::app()->user->id)
								|| Yii::app()->user->checkAccess('ExternalGS', Yii::app()->user->id))),
						),
					),
					array(
						...
						'visible'=>!Yii::app()->user->isGuest,
						'items'=>array(
							array('label'=>'Evaluations', 'url'=>array($this->createAbsoluteUrl('/evaluations/evaluations/index')), 'visible'=>!Yii::app()->user->isGuest),
							array('label'=>'Evaluation Questions', 'url'=>array($this->createAbsoluteUrl('/evaluations/evaluationquestions/index')), 'visible'=>Yii::app()->user->checkAccess('Supervisor', Yii::app()->user->id)),
						),
					),
					array(
						...
						'visible'=>Yii::app()->user->checkAccess('IT', Yii::app()->user->id),
						'items'=>array(
							array('label'=>'Printers & Copiers', 'url'=>array($this->createAbsoluteUrl('/links/links/printersCopiers')), 'visible'=>Yii::app()->user->checkAccess('IT', Yii::app()->user->id)),
						),
					),
					array(
						...
						'visible'=>!Yii::app()->user->isGuest,
						'items'=>array(
							array('label'=>'Logout', 'url'=>array($this->createAbsoluteUrl('/security/login/logout'))),
							array('label'=>'Change Password', 'url'=>array($this->createAbsoluteUrl('/security/password/changePassword'))),
						),
					),
				)
			)); ?>
